...
class AnalyticsBackgroundJobs {
    ...
    startScheduler() {
        ...
        const dailyJob = cron.schedule('0 2 * * *', () => {
            ...
            this.updateAllCourseAnalytics().catch(console.error);
        }, {
            scheduled: false,
    ...
    async updateAllCourseAnalytics() {
        try {
            ...
            for (const program of programs) {
                await this.updateCourseAnalyticsForProgram(program.program_id);
            }
    ...
    async updateCourseAnalyticsForProgram(program_id) {
        try {
            ...
            for (const subject of subjects) {
                await this.updateSubjectAnalysis(subject.course_id, program_id, currentSemester, academicYear);
            }
    ...
    async updateSubjectAnalysis(course_id, program_id, semester, academic_year) {
        ...
        try {
            ...
            const courseStats = await this.calculateSubjectStatistics(course_id, program_id, transaction);
            const poAchievement = await this.calculatePOAchievementForCourse(course_id, program_id, transaction);
            const ploAchievement = await this.calculatePLOAchievementForCourse(course_id, program_id, transaction);
            const loPerformance = await this.calculateLOPerformanceForCourse(course_id, transaction);
            const difficultyAnalysis = await this.calculateDifficultyAnalysisForCourse(course_id, transaction);
            
            const analysisData = {
                subject_statistics: courseStats,
    ...
    async calculateSubjectStatistics(course_id, program_id, transaction) {
        return {
    ...
    async calculatePOAchievementForCourse(course_id, program_id, transaction) {
        return {};
    }
    
    async calculatePLOAchievementForCourse(course_id, program_id, transaction) {
        return {};
    }
    
    async calculateLOPerformanceForCourse(course_id, transaction) {
        return {};
    }
    
    async calculateDifficultyAnalysisForCourse(course_id, transaction) {
        return {
